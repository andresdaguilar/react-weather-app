...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../css-loader/index.js!../../sass-loader/lib/loader.js!./react-select.css", function() {
			var newContent = require("!!../../css-loader/index.js!../../sass-loader/lib/loader.js!./react-select.css");
...
var _application = __webpack_require__(47);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(process.env.NODE_ENV!=="production"){(function(){'use strict';var React=__webpack_require__(1);var invariant=__webpack_require__(4);var warning=__webpack_require__(6);var ExecutionEnvironment=__webpack_require__(11);var _assign=__webpack_require__(3);var emptyFunction=__webpack_require__(2);var EventListener=__webpack_require__(12);var getActiveElement=__webpack_require__(13);var shallowEqual=__webpack_require__(14);var containsNode=__webpack_require__(15);var focusNode=__webpack_require__(16);var emptyObject=__webpack_require__(5);var checkPropTypes=__webpack_require__(7);var hyphenateStyleName=__webpack_require__(29);var camelizeStyleName=__webpack_require__(31);/**
 * WARNING: DO NOT manually require this module.
 * This is a replacement for `invariant(...)` used by the error code system
 * and will _only_ be required by the corresponding babel pass.
 * It always throws.
...
var _reactSelect = __webpack_require__(17);

var _reactSelect2 = _interopRequireDefault(_reactSelect);

__webpack_require__(19);

var _weather = __webpack_require__(40);

var _addcity = __webpack_require__(41);

var _reactLoader = __webpack_require__(42);
...
var App = exports.App = function (_Component) {
    ...
    function App(props) {
        ...
        _this.state = { currentCity: 0, isLoading: true, weather: [] };
        _this.cities = [];
        fetch('./api/getCities').then(function (result) {
            return result.json();
        }).then(function (items) {
            _this.cities = items;
            _this.updateWeather();
    ...
    _createClass(App, [{
        ...
        value: function updateWeather() {
            ...
            var _loop = function _loop(i) {
                fetch('./api/weather/' + _this2.cities[i].id).then(function (result) {
                    return result.json();
                }).then(function (items) {
                    _this2.cities[i].weather = items;
        ...
        value: function tick() {
            ...
            var next = this.state.currentCity == this.cities.length - 1 ? 0 : this.state.currentCity + 1;
            if (this.cities[next].weather == undefined) {
                fetch('./api/weather/' + this.cities[next].id).then(function (result) {
                    return result.json();
                }).then(function (items) {
                    return _this4.cities[next].weather = items;
                });
            }
        ...
        value: function handleClick(city) {
            ...
            fetch('./api/weather/' + city.id).then(function (result) {
                return result.json();
            }).then(function (items) {
                city.weather = items;
                _this5.cities.push(city);
            });
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            if (this.cities.length > 0) {
                ...
                return _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement(_weather.WeatherWidget, { city: city, temp: temp, icon: icon, state: state_name }),
                    _react2.default.createElement(_addcity.AddCity, { onClick: this.handleClick })
                );
            } else {
                return _react2.default.createElement(
                    'div',
                    ...
                    _react2.default.createElement(_reactLoader2.default, { loaded: false, lines: 13, length: 20, width: 10, radius: 20,
...
exports.WeatherState = exports.WeatherWidget = undefined;
...
var WeatherWidget = exports.WeatherWidget = function (_Component) {
    _inherits(WeatherWidget, _Component);

    function WeatherWidget(props) {
        _classCallCheck(this, WeatherWidget);

        return _possibleConstructorReturn(this, (WeatherWidget.__proto__ || Object.getPrototypeOf(WeatherWidget)).call(this, props));
    }
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(WeatherState, { icon: this.props.icon }),
                    _react2.default.createElement(
                        "p",
                        null,
                        this.props.state
...
var WeatherState = exports.WeatherState = function (_Component2) {
    _inherits(WeatherState, _Component2);

    function WeatherState(props) {
        _classCallCheck(this, WeatherState);

        var _this2 = _possibleConstructorReturn(this, (WeatherState.__proto__ || Object.getPrototypeOf(WeatherState)).call(this, props));

        _this2.urlImg = 'https://www.metaweather.com/static/img/weather/';
        return _this2;
    }

    _createClass(WeatherState, [{
        key: "render",
        value: function render() {
            var icon = this.props.icon != "" ? this.urlImg + this.props.icon + ".svg" : "";
            return _react2.default.createElement("img", { src: icon, className: "imageState" });
        }
    }]);
...
var AddCity = exports.AddCity = function (_Component) {
    _inherits(AddCity, _Component);

    function AddCity(props) {
        _classCallCheck(this, AddCity);

        var _this = _possibleConstructorReturn(this, (AddCity.__proto__ || Object.getPrototypeOf(AddCity)).call(this, props));

        _this.url = 'https://www.metaweather.com/api/location/search/?query=';
        _this.state = { value: ' ' };
        _this.handleClick = _this.handleClick.bind(_this);
    ...
    _createClass(AddCity, [{
        ...
        value: function getOptions(input) {
            return fetch('/api/search/' + input).then(function (response) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'button',
                    { id: 'add', disabled: this.state.name == '', className: 'btn btn-default', onClick: this.handleClick.bind(this) },
                    'Add City ',
                    this.state.name
                )
            );
...
(function (root, factory) {
  ...
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(9), __webpack_require__(43), __webpack_require__(10), __webpack_require__(45)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
...
})(undefined, function (React, ReactDOM, Spinner, PropTypes, createReactClass) {
