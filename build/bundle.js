...
var _reactInputAutosize = __webpack_require__(175);
...
exports.AddCity = exports.WeatherState = exports.WeatherWidget = exports.App = undefined;
...
var _reactSelect = __webpack_require__(242);
        ...
        value: function render() {
            ...
            if (this.cities.length > 0) {
                ...
                return _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement(WeatherWidget, { city: city, temp: temp, icon: icon, state: state_name }),
                    _react2.default.createElement(AddCity, { onClick: this.handleClick })
                );
            } else {
                return _react2.default.createElement(
                    'h1',
...
var WeatherWidget = exports.WeatherWidget = function (_Component2) {
    _inherits(WeatherWidget, _Component2);
...
var WeatherState = exports.WeatherState = function (_Component3) {
    _inherits(WeatherState, _Component3);

    function WeatherState(props) {
        _classCallCheck(this, WeatherState);

        var _this7 = _possibleConstructorReturn(this, (WeatherState.__proto__ || Object.getPrototypeOf(WeatherState)).call(this, props));

        _this7.urlImg = 'https://www.metaweather.com/static/img/weather/';
        return _this7;
    }
    ...
    _createClass(WeatherState, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement('img', { src: this.urlImg + this.props.icon + ".svg", className: 'imageState' });
        }
    }]);
...
var AddCity = exports.AddCity = function (_Component4) {
    _inherits(AddCity, _Component4);

    function AddCity(props) {
        _classCallCheck(this, AddCity);

        var _this8 = _possibleConstructorReturn(this, (AddCity.__proto__ || Object.getPrototypeOf(AddCity)).call(this, props));

        _this8.url = 'https://www.metaweather.com/api/location/search/?query=';
        _this8.state = { value: '' };
        _this8.handleClick = _this8.handleClick.bind(_this8);
        _this8.updateValue = _this8.updateValue.bind(_this8);
        return _this8;
    }
